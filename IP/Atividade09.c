...
int contaCaracteres1(char* palavra) {
  int total = 0;
    for(int i = 0; palavra[i] != '\0'; i++){
      if (palavra[i] > 32) total += 1;
...
int main() {
  ...
  printf("Bota a string seu comédia ");
  fgets(nomes3, 100, stdin); 

  printf("Tua string tem ");
  if (contaCaracteres1(nomes3) == 0) printf("%i char, comédia");
  else printf("Tua string tem %i char, comédia ", contaCaracteres1(nomes3));
